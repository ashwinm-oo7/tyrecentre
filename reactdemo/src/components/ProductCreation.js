    ...
    return (
      <div className="container-fluid">
        ...
        <div className="col-lg-1 text-left p-2">
          {this.state.isAdmin && (
            <a className="btn btn-link text-success p-0" onClick={() => this.open('brand')}>
        ...
        <div className="col-lg-2">
          <div className="form-group">
            <label className="form-control-label">Specifications :</label>
          </div>
        </div>
        <div className="col-lg-9 text-right pr-0">
          <div className="row">
            {this.state.specificationsByProductType.map((specification, index) => (
              <div className="col-lg-5" key={index}>
                <div className="row form-group">
                  <div className="col-sm-4">
                    <div className="input-group-sm">
                      <input
                        ...
                        onBlur={(event) => this.updateList(index, 'specificationName', event)}
                  ...
                  <div className="col-sm-6 pr-0 input-group-sm">
                    <input
                      type="text"
                      onBlur={(event) => this.updateList(index, 'value', event)}
                  ...
                  <div className="col-sm-1 input-group-sm">
                    {!specification.mandatory && (
                      <a onClick={() => this.removeSpecification(index)} href="#">
                        <i className="fa fa-trash fa-lg" aria-hidden="true" style={{ color: 'rgb(238, 34, 51)' }}></i>
                      </a>
                    )}
                  </div>
                </div>
            ...
            <div className="col-sm-1">
              <a className="btn btn-link text-success p-0" onClick={() => this.addSpecification()}>
                <i className="fa fa-plus append-icon" style={{ fontSize: 'x-large' }}></i>
              </a>
            </div>
          </div>
        </div>
