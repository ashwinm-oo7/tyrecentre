                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="#"> Bike <i class="fa fa-angle-down"></i> </a>
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
                                                ...
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-img"><a href="#"><img src="assets/img/cars/bike.webp" alt=""/></a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </li>
                                        <li><a href="#">Scooter <i class="fa fa-angle-down"></i></a>
                                            <ul class="mega-menu">
                                                <li>
                                                    <ul>
                                                        <li class="mega-menu-title"><a href="#">shop layout</a></li>
                                                        ...
                                                        <li class="mega-menu-img"><a href="#"><img src="assets/img/cars/scooter.webp" alt=""/></a></li>
                                                </ul>    
                                        </li>
