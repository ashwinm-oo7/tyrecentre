...
import ProceedToPay from "./ProceedToPay.js"; // Import the ProceedToPay component
...
class CartPage extends Component {
  ...
  render() {
    const { cart } = this.state;
    const finalAmountToPay = (this.calculateTotal() * 1.28).toFixed(2);
    ...
    return (
      <div>
        ...
        <div className="cart-shopping-total">
          ...
          >
            <ProceedToPay finalAmount={finalAmountToPay} cart={cart} />
          </div>
        </div>
      </div>
    );
